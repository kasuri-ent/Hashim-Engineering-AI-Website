...
export const CalculatorPage: React.FC<CalculatorPageProps> = ({ onOpenQuoteModal, onNavigate }) => {
  ...
  useEffect(() => {
    updatePageSeo({
      title: 'Solar System Sizing & Cost Calculator Pakistan | Hashim Engineering',
      description: 'Calculate your required solar kW system size, monthly electricity savings, number of Tier-1 solar panels, and estimated payback period in Pakistan.',
      ...
      <div className="relative border-b border-slate-800/80 bg-[#0e1422] pt-10 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center gap-2 text-xs text-slate-400 mb-6">
            ...
            <span className="text-white font-medium">Solar Sizing Calculator</span>
          </nav>

          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#c51e28] mb-3">
              <Calculator className="w-4 h-4" />
              <span>Instant Electrical Engineering Estimation</span>
            </div>
            <h1 className="text-3xl sm:text-5xl font-extrabold font-display tracking-tight text-white leading-tight">
              Solar Sizing, Bill Offset &amp; Payback Calculator
            </h1>
            <p className="mt-4 text-base sm:text-lg text-slate-300 leading-relaxed">
              Estimate your recommended system capacity, required roof space, monthly unit generation, and estimated capital return based on prevailing DISCO utility tariffs.
            </p>
          </div>
